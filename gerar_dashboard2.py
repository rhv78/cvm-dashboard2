...
# Cota mantida original — a divisão por 1000 é feita na quantidade de cotas
...
for cnpj_raw, nome in CNPJS.items():
    ...
    if cnpj_raw in cota_base:
        ...
        # patrimônio = cotas_qt * cota (1000x menor que o patrimônio total do fundo)
        hist.append({
            "dt": "2025-12-31",
...
function getDS(tab){
  ...
  return [...dsCDI, ...dsLagunna, ...dsGrupos];
}
